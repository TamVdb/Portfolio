...
const projects = [
   {
      ...
      category: "fullstack",
      title: "Plan My Trip",
      description: "Application de planification de voyages développée en React. Elle permet de créer des activités et de les organiser par jour grâce au drag and drop.",
   ...
   },
   {
      ...
      live: "https://shake-and-taste.vercel.app/index.html",
                           ...
                           <SwiperSlide key={index} className="w-full">
                              <div className="h-[460px] relative group flex justify-center items-center bg-pink-50/20">
                                 ...
                                 <div className="relative w-full h-full">
                                    <img src={project.image} alt="" className="object-cover" fill />
                                 </div>
                              </div>
                           </SwiperSlide>
                        );
