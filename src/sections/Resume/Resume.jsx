					...
					<div className='flex flex-col items-center justify-center'>
						<Tabs defaultValue='skills' className='w-full flex flex-col xl:flex-row gap-16'>
							<TabsList className='flex flex-col w-full max-w-[380px] mx-auto xl:mx-0 gap-6'>
								<TabsTrigger value='skills' aria-label='Compétences' tabIndex='0' aria-selected='true'>
									{t('skills.title')}
								</TabsTrigger>
								<TabsTrigger value='experience' aria-label='Expériences professionnelles' tabIndex='0'>
									{experiences.title}
								</TabsTrigger>
								<TabsTrigger value='education' aria-label='Mes formations' tabIndex='0'>
									{education.title}
								</TabsTrigger>
								<TabsTrigger value='about' aria-label='À propos de moi' tabIndex='0'>
									{about.title}
								</TabsTrigger>
							</TabsList>
							...
							<div className='w-full'>
								...
								>
									<div className='flex flex-col gap-6'>
										{/* Title */}
										<h3 className='text-4xl xl:text-5xl font-bold text-center xl:text-left'>
											{t('skills.title')}
										</h3>
												...
												return (
													<li key={index}>
														<TooltipProvider delayDuration={100}>
															<Tooltip>
																<TooltipTrigger
																	className='h-[55px] w-[55px] sm:h-[80px] sm:w-[80px] lg:h-[100px] lg:w-[100px] bg-[#23262e] rounded-xl flex justify-center items-center group'
																	aria-label={skill.name}
																>
																	<div
																		className='text-3xl sm:text-4xl lg:text-5xl group-hover:text-accent transition-all duration-300'
																		aria-hidden='true'
																	>
																		{skill.icon}
																	</div>
								...
								>
									<div className='flex flex-col gap-6'>
										...
										<p className=' text-white/90 mx-auto xl:mx-0'>{about.description}</p>
